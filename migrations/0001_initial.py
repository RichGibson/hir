...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Space'
        db.create_table(u'hir_space', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
            ('content', self.gf('mezzanine.core.fields.RichTextField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('hackerspace', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.send_create_signal(u'hir', ['Space'])

        # Adding model 'Residency'
        db.create_table(u'hir_residency', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
            ('content', self.gf('mezzanine.core.fields.RichTextField')()),
            ('offer', self.gf('django.db.models.fields.TextField')()),
            ('resources', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'hir', ['Residency'])


    def backwards(self, orm):
        # Deleting model 'Space'
        db.delete_table(u'hir_space')

        # Deleting model 'Residency'
        db.delete_table(u'hir_residency')
