...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offer.label'
        db.add_column(u'hir_offer', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Required.label'
        db.add_column(u'hir_required', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offer.label'
        db.delete_column(u'hir_offer', 'label')

        # Deleting field 'Required.label'
        db.delete_column(u'hir_required', 'label')
